<!-- Updated based on project-nav.md, blueprint.md, and project.md: Added HTTPaySDK main class, AI-Wallet demo, and E2E testing tasks. All deliverables and flows from the MVP spec are now reflected. -->
