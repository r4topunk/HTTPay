import { ToolPaySDK, ToolPaySDKConfig } from '../src/toolPaySDK';
...
describe('ToolPaySDK', () => {
  let mockConfig: ToolPaySDKConfig;
  ...
  it('should initialize with valid configuration', () => {
    // Act
    const sdk = new ToolPaySDK(mockConfig);

    // Assert
    expect(sdk).toBeInstanceOf(ToolPaySDK);
  ...
  it('should throw an error for invalid configuration', () => {
    ...
    // Act & Assert
    expect(() => new ToolPaySDK(invalidConfig as ToolPaySDKConfig)).toThrow(
      'Failed to initialize ToolPaySDK',
    );
  });
